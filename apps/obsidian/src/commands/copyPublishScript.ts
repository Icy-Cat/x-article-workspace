...
import {
	buildBrowserPublishFunction as buildSharedBrowserPublishFunction,
	buildBrowserPublishScript as buildSharedBrowserPublishScript,
} from "@x-article/publish";
...
export async function buildPublishScriptFromActiveNote(
	...
	return buildSharedBrowserPublishScript(payload);
}
...
export async function buildPublishFunctionFromActiveNote(
	...
	const payload = await buildPublishPayloadFromActiveNote(plugin);
	return buildSharedBrowserPublishFunction(payload);
}
